class TouringPlansSync
  ...
  def update_eatery_from_touringplans_com(route:, representation: {})
    ...
    tp_eatery.update(name:      remote_tp_park_venue.name                       || tp_eatery_default.name,
       ...
       phone_number:            remote_tp_park_venue.phone_number               || tp_eatery_default.phone_number,
       cost_code:               remote_tp_park_venue.cost_code                  || tp_eatery_default.cost_code,
       cuisine:                 remote_tp_park_venue.cuisine                    || tp_eatery_default.cuisine,
       when_to_go:              remote_tp_park_venue.when_to_go                 || tp_eatery_default.when_to_go,
       entree_range:            remote_tp_park_venue.entree_range               || tp_eatery_default.entree_range,
       portion_size:            remote_tp_park_venue.portion_size               || tp_eatery_default.portion_size,
       bar:                     remote_tp_park_venue.bar                        || tp_eatery_default.bar,
       wine_list:               remote_tp_park_venue.wine_list                  || tp_eatery_default.wine_list,
       parking:                 remote_tp_park_venue.parking                    || tp_eatery_default.parking,
       ...
       table_value_rating:      remote_tp_park_venue.table_value_rating         || tp_eatery_default.table_value_rating,
